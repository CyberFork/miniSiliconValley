...
- 固定 P／D／M 课件：`/courseware/product-mentor-foundations/`、`/courseware/development-mentor-ligun/`、`/courseware/market-mentor-user-system/`，原样复制并统一经 cookie-only `auth_request` 保护；导师与学员从 `/course/` 只读访问。
