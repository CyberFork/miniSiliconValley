...
产品经理导师课件使用同一 package 的不可变版本：历史 `r0` 来自 commit `679213a61b835335016eac7649213983a0e48489`、tree `3a041c4714190cc026f6de8e06e15cec0e5f765d`；当前 `r1` 来自 `chj9-11` commit `d9d45f1396b54a7ac6b41715b31122d8ffc597ff`、tree `d26045a3eb1c249629092dcddeb82e7812ff0ff5`。构建不得编辑同事源码，旧课堂 exact 引用始终解析到 `r0`，默认发布指针才推进到 `r1`。
