...
class GatewayContractTests(unittest.TestCase):
    ...
    def test_120_minute_decks_protect_all_teacher_assets_at_new_revision_paths(self) -> None:
        for path in ("development-mentor-module-thinking/r5", "development-mentor-module-thinking/r6", "development-mentor-module-thinking/r7", "development-mentor-ligun/r1", "development-mentor-ligun/r2"):
