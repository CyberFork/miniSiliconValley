    ...
    for path, expected in EXPECTED.items():
        ...
        if path == "/release.json":
            ...
            for key, slug, revision, digest, audience_files, teacher_files in (
                ("moduleThinkingCoursewareArtifact", "development-mentor-module-thinking", 9, "a336543585d9b53d3bb1596f066bb4ccd8358d0df9d21152280130624d745f44", 28, 21),
                ("ligun120CoursewareArtifact", "development-mentor-ligun", 4, "8e160cb6c9b57bf25dd485a591c59fbe5f20e4426f32c358070e326a9590a280", 31, 14),
            ):
