    ...
    for path, expected in EXPECTED.items():
        ...
        if path == "/release.json":
            ...
            for key, slug, revision, digest, audience_files, teacher_files in (
                ("moduleThinkingCoursewareArtifact", "development-mentor-module-thinking", 8, "971cc25ef8fba30f6377a2d5caa86841f29bbf8a56f227776bc9ab0909236c17", 26, 18),
                ("ligun120CoursewareArtifact", "development-mentor-ligun", 3, "dba0adb24b45d1942d36a06b9baa97fe833bffd53e0fd9a71f65956c90587396", 29, 11),
            ):
