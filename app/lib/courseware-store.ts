...
const DEVELOPMENT_MODULE_THINKING_R4_CONTENT_TREE = "5d0e6d1dd92c10c99ad4767d33d92ef1039733996f9ec909d5a0910572787644";
const DEVELOPMENT_MODULE_THINKING_R5_CONTENT_TREE = "84ab82bcba6a34aab72284b3fc4f8d05b3f243bed4e8493c04fd9ab437b05412";
...
const BUNDLED_VERSIONS = [
  ...
  },
  {
    ...
    role: "D" as const,
    revision: 4,
    releasedAt: "2026-09-19T02:00:22Z",
    isCurrent: false,
    kind: "static-bundle" as const,
    entryPath: "/courseware/development-mentor-module-thinking/audience/",
    sourceIdentity: `t130:sha256:${DEVELOPMENT_MODULE_THINKING_R4_CONTENT_TREE}`,
    html: null,
  },
  {
    id: "cw-development-mentor-module-thinking",
    ...
    isCurrent: false,
    kind: "static-bundle" as const,
    entryPath: "/courseware/development-mentor-module-thinking/r5/audience/",
    sourceIdentity: `t132:sha256:${DEVELOPMENT_MODULE_THINKING_R5_CONTENT_TREE}`,
    html: null,
  },
  {
    id: "cw-development-mentor-module-thinking",
    ...
    role: "D" as const,
    revision: 6,
    releasedAt: "2026-09-19T07:30:00Z",
    isCurrent: false,
    kind: "static-bundle" as const,
    entryPath: "/courseware/development-mentor-module-thinking/r6/audience/",
    sourceIdentity: `t132:sha256:${DEVELOPMENT_MODULE_THINKING_R6_CONTENT_TREE}`,
    html: null,
  },
  {
    id: "cw-development-mentor-module-thinking",
    ...
    role: "D" as const,
    revision: 7,
    releasedAt: "2026-09-19T07:45:00Z",
    isCurrent: false,
    kind: "static-bundle" as const,
    entryPath: "/courseware/development-mentor-module-thinking/r7/audience/",
    sourceIdentity: `t132:sha256:${DEVELOPMENT_MODULE_THINKING_R7_CONTENT_TREE}`,
    html: null,
  },
  {
    id: "cw-development-mentor-module-thinking",
...
export function defaultCoursewareRefs(summaries: CoursewareSummary[]): ExactCoursewareRef[] {
  // A role may own several independently released decks. Classroom startup
  // therefore uses an explicit syllabus default rather than whichever package
