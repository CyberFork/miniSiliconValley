...
export const parentQaKnowledge = [
  ...
  },
  {
    ...
    category: "适龄与班型",
    title: "4 位导师协作支持 4 名学员",
    content:
      "标准完整班型由 4 位导师和 4 名学员组成：产品导师担任主 DM，开发、市场、运营导师按步骤主责或支援。4 名学员统一是 Young Builder，不被固定成 P／D／M／O。课堂可结合 WebApp、实体卡牌、地图和毛线建网；每名学员拿到不同线索，必须互讲和协作完成拼图。",
  ...
  },
  {
    ...
    content:
      "标准课堂依次经历：进入情境与领取身份、随机抽取私密信息、毛线式互讲与证据连线、在导师带领下进行情境攻坚、共同完成两轮试做、用德式资源机制衡量投入与收益、先锁定玩家世界线再揭示史实，最后复盘并迁移到现实任务。四位导师按 P／D／M／O 专业线配合，学员始终是共同完成任务的 Young Builder。",
