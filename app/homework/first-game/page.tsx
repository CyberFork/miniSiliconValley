...
export default async function FirstGameHomeworkPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.hero}><small>FIXED MISSION · NO LOGIN</small><h1>把脑中的游戏<br />讲清楚。</h1><p>这不是作文，也不是比谁写得多。先完成第一部分的 01—05，再继续探索第二部分。用短句和表格，让别人知道你的游戏是什么、怎么玩、为什么好玩。</p></section>
