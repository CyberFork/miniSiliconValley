...
export default function FirstGameHomeworkPage() {
  return <main className={styles.page}>
    <header className={styles.top}><BrandHomeLink title="HOMEWORK LAB" subtitle="我的第一款游戏" /><nav><a href={publicPath("/terminal/")}>时空终端</a><a href={publicPath("/homework/first-game/submissions/")}>查看全部提交</a></nav></header>
    ...
    <aside className={styles.publicWarning} role="note"><strong>⚠ 这是一份公开作业</strong><p>填写和查看都不需要登录。任何知道查看页地址的人都能看到你提交的昵称、文字和图片。请使用昵称，不要填写手机号、住址、证件、密码或他人的私密信息。</p></aside>
