...
> 课程平台（Course Studio、Courseware、Classroom 与课程工厂）的已确认目标架构，统一见 [COURSE_PLATFORM_ARCHITECTURE.md](COURSE_PLATFORM_ARCHITECTURE.md)。本文件以下内容主要记录当前世界站点及既有代码结构，不应被视为新的课程平台领域真值。
