...
export async function buildDeck(name){
 ...
 for(const surface of ['audience','teacher']){
  ...
  if(p1){await cp(join(engine,'module-3d.js'),join(target,'module-3d.js'));await cp(join(engine,'vendor'),join(target,'vendor'),{recursive:true});}
 }
