(function () {
  ...
  "version": "2026.09.19-p1-r6",
  "legacySlideIds": ["module-s01","module-s02","module-s02-build","module-s02-voxel","module-s03","module-s04","module-s05","module-s06","module-s07","module-s08","module-s09","module-s10","module-s11","module-s12","module-s13","module-s14","module-s15","module-s16"],
  ...
  "slides": [
    ...
    },
    {
      ...
      "section": "核心工具",
      "title": "收到什么？怎样做？交回什么？",
      "subtitle": "自动门和登录模块，都能这样观察。接口是彼此合作的约定。",
      "theme": "blueprint",
      "content": "<div class=\"lesson-grid cols-3\"><article><h3>输入</h3><p>账号和密码，交给登录模块。</p></article><article><h3>处理</h3><p>按约定核对身份。</p></article><article><h3>输出</h3><p>允许进入，或告诉你为什么进不去。</p></article></div><div class=\"lesson-banner\"><b>接口贯穿合作</b><span>交什么格式？谁来接？失败怎样通知？不是“输出之后再做一步”。</span></div><div class=\"lesson-banner\" data-reveal><b>先配对，再解释</b><span>将账号密码、核对身份、允许／拒绝、登录按钮与认证请求，放到对应位置。</span></div>",
      "phase": "WHAT · 认识模块",
      "minutes": 5
    },
    {
      ...
      "section": "马上用到我的游戏",
      "title": "用六句话，说清一个模块",
      "subtitle": "先说白话，再把它整理成一张“工作证”。",
      "theme": "paper",
      "content": "<div class=\"lesson-grid cols-3\"><article><h3>职责｜我只负责</h3><p>自动门：判断是否开门，不负责给访客登记。</p></article><article><h3>输入｜我收到</h3><p>有人靠近、门口是否安全、当前门状态。</p></article><article><h3>处理规则｜我怎么做</h3><p>有人靠近且安全才打开，不能撞到人。</p></article><article><h3>输出｜我交回</h3><p>开门／保持关闭，以及当前状态。</p></article><article><h3>接口｜我怎样合作</h3><p>谁发感应信号？开不了时告诉谁？</p></article><article><h3>正常／异常｜不顺利怎么办</h3><p>正常开门；感应失效时提示改走人工通道。</p></article></div>",
      "phase": "WHAT · 认识模块",
      "minutes": 5
    },
    {
    ...
    },
    {
      ...
      "section": "马上用到我的游戏",
      "title": "拆得越碎，就一定越好吗？",
      "subtitle": "多一个模块，也多一份需要说清的交接。",
      "theme": "paper",
      "content": "<div class=\"lesson-grid cols-2\"><article><h3>直接复用</h3><p>已有轮组接口合适，就不必重新造轮子。</p></article><article><h3>自己制作</h3><p>需要特别的轮组，可以自建，但要自己测试。</p></article><article><h3>值得拆开</h3><p>同类事情放一起，换一块时少影响别人。</p></article><article><h3>暂时不拆</h3><p>把每个字、每个按钮都拆一块，交接反而更乱。</p></article></div><div class=\"lesson-banner\" data-reveal><b>判断问题</b><span>这样拆，是让合作更清楚，还是只是让格子更多？</span></div>",
      "phase": "WHY · 为什么要用",
      "minutes": 4
    },
    {
