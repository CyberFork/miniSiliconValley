...
for (const [name,constant,route] of [["module-thinking-deck","DEVELOPMENT_MODULE_THINKING_R9_CONTENT_TREE","development-mentor-module-thinking/r9"],["ligun-deck","DEVELOPMENT_LIGUN_R4_CONTENT_TREE","development-mentor-ligun/r4"]]) {
