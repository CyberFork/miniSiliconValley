...
T-122 建立的双视图课件，已由 T-132 重排为 `2026.09.19-p1-r6` 本地候选版：保留原 18 页 ID，扩展为 25 张 16:9 投屏页面、120 分钟。S02 用三页递进讲清“预制组件重组 → 用基础零件创造组件 → 用材料方块塑形组件并组合对象”，并加入本地自托管的 Three.js 三维课堂示意。
...
完整使用方式、P2 衔接与候选发布边界见 [共同说明](../shared/README.md)。
