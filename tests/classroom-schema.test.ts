...
test("unified course factory keeps release, courseware, permissions and script progress exact", () => {
  for (const marker of [
    ...
    "uidx_classroom_archive_room",
    "uidx_classroom_archive_idempotency",
    ...
    "uidx_homework_first_game_request",
    "trg_homework_first_game_immutable_update",
    "trg_homework_first_game_immutable_delete",
    "uidx_homework_ai_quiz_request",
    "trg_homework_ai_quiz_immutable_update",
    "trg_homework_ai_quiz_immutable_delete",
    "uidx_homework_template_request",
    "uidx_homework_assignment_request",
    "uidx_homework_response_recipient",
