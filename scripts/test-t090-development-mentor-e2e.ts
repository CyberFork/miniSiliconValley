...
try {
  ...
  assert.equal(dCourseware.latestRevision, 3);
  assert.equal(dCourseware.latestDigest, createHash("sha256").update(`static-bundle:/courseware/development-mentor-ligun/r3/audience/:t133:sha256:${p2Build.digest}`).digest("hex"));
